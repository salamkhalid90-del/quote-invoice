...
const globalForPrisma = globalThis as unknown as {
  prisma?: PrismaClient;
  ensureDatabasePromise?: Promise<void>;
};
...
const sqliteStatements = [
  `CREATE TABLE IF NOT EXISTS "CompanySetting" (
    ...
    "defaultPaymentPlan" TEXT NOT NULL DEFAULT '',
...
export async function ensureDatabase() {
  if (!globalForPrisma.ensureDatabasePromise) {
    globalForPrisma.ensureDatabasePromise = (async () => {
  ...
  return globalForPrisma.ensureDatabasePromise;
}
